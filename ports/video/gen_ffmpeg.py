#!/usr/bin/env python3
"""Prebuild step for psram_video: FFmpeg's configure output, without configure.
...
compiled are listed explicitly in apps/psram_video/papp.json; they are what
...
# What psram_video plays. Decoders and demuxers first, then the parsers the
...
def main() -> int:
    ...
    (gen / "config.h").write_text(f"""/* Generated by ports/video/gen_ffmpeg.py for psram_video - do not modify. */
#ifndef FFMPEG_CONFIG_H
#define FFMPEG_CONFIG_H
#define FFMPEG_CONFIGURATION "psram_video (ports/video/gen_ffmpeg.py)"
