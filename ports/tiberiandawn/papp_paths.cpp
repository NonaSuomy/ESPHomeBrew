// Paths and file lookup for the Tiberian Dawn PAPP (replaces common/paths_posix.cpp
// and common/file_posix.cpp). Program, data and user files all live in one
// folder on the SD card; CONQUER.INI there can still override them.
#include "papp_port.h"
