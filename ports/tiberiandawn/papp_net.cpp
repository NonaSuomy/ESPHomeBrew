// BSD sockets for the Tiberian Dawn PAPP, just enough for Vanilla Conquer's network
...
{
    static const char host[] = "tiberiandawn-p4";
...
struct hostent* gethostbyname(const char* name)
{
    ...
    static char host_name[] = "tiberiandawn-p4";
